    ...
    return (
        <>
            ...
            <div className="checkout-page">
                {cart.length === 0 ? <div className="page-title">Your cart is empty</div> : <div className="page-title">Review your order</div>}
                                    ...
                                    <div className="cart-item-details-grid">
                                        ...
                                        <div className="delivery-options">
                                            ...
                                            {deliveryOptions.map((deliveryOption) => {
                                                ...
                                                let priceString
                                                priceString = deliveryOption.priceCents > 0 ? `$${(deliveryOption.priceCents / 100).toFixed(2)}-shipping` : 'FREE shipping'
                                                return (
                                                    <div key={deliveryOption.id} className="delivery-option">
                                                        <input type="radio" checked={deliveryOption.id === cartItem.deliveryOptionId}
                                                            className="delivery-option-input"
                                                            name={cartItem.id} onClick={updateDeliveryOption} />
                                                        <div>
